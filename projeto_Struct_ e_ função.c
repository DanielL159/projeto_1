...
struct backup
{
    char nomeB[50],emailB[50],sexoB[15];
    double alturaB;
    int vacinaB,idB;

    

    struct bEndereco enderecoB;
...
void cadastrar(struct cliente p[1000],int*counte){
    ...
    for(i = (*counte); i < 1000; i++){
              ...
              do{
				    ...
				    if(strcmp(p[i].sexo, "Feminino") != 0 && strcmp(p[i].sexo, "Masculino") != 0 && strcmp(p[i].sexo, "Nao_declarar") != 0)
							printf("Sexo invalido\n");
							
			    } while (strcmp(p[i].sexo, "Feminino") != 0 && strcmp(p[i].sexo, "Masculino") != 0 && strcmp(p[i].sexo, "Nao declarar") != 0);
              ...
              //  fflush(stdin);
               // fgets(p[i].endereco,50,stdin);
                ...
                do{
                    ...
                    if(p[i].altura < 1.0 || p[i].altura > 2.0){
                ...
                }while (p[i].altura < 1.0 || p[i].altura > 2.0);
                ...
                printf("CEP: ");
                fflush(stdin);
                fgets(p[i].endereco.cep, 10, stdin);
...
void editar(struct cliente p[1000]){
    ...
    int edita,index;
      printf("Digite o index que voce deseja editar: ");
				...
				switch (edita){
					...
					case 3:
						do{
                                ...
                                //	fflush(stdin);
                                //fgets(sexo[index], 50,stdin);
                                scanf("%s", &p[index].sexo);
					
						
                                if(strcmp(p[index].sexo, "Feminino") != 0 && strcmp(p[index].sexo, "Masculino") != 0 && strcmp(p[index].sexo, "Nao_declarar") != 0)
                                    printf("Sexo invalido\n");
                                        
                            } while (strcmp(p[index].sexo, "Feminino") != 0 && strcmp(p[index].sexo, "Masculino") != 0 && strcmp(p[index].sexo, "Nao declarar") != 0);
                ...
                printf("Rua: ");
                fflush(stdin);
                fgets(p[index].endereco.rua, 30, stdin);
                break;

                case 8:
                printf("Cidade: ");
                fflush(stdin);
                fgets(p[index].endereco.cidade, 30, stdin);
                break;

                case 9:
                printf("Estado: ");
                fflush(stdin);
                fgets(p[index].endereco.estado, 30, stdin);
                break;

                case 10:
                printf("CEP: ");
                fflush(stdin);
                fgets(p[index].endereco.cep, 10, stdin);
                break;
					default:
						printf("\nOpcao invalida\n");
						break;
...
void backupp(struct backup back[1000],struct cliente cadastrado[1000]){
  ...
  for(int j = 0; j < 1000; j++){
                ...
                strcpy(back[j].enderecoB.brua , cadastrado[j].endereco.rua);
                strcpy( back[j].enderecoB.bcidade , cadastrado[j].endereco.cidade);
                strcpy(back[j].enderecoB.bestado , cadastrado[j].endereco.estado);
                strcpy(back[j].enderecoB.bcep, cadastrado[j].endereco.cep);
...
void restauracao(struct cliente cadastrado[1000],struct backup back[1000]){
       ...
       for (int j = 0; j < 1000; j++){
                ...
                //cadastrado[j]=back[j]	 
                strcpy(cadastrado[j].endereco.rua , back[j].enderecoB.brua);
                strcpy(cadastrado[j].endereco.cidade , back[j].enderecoB.bcidade);
                strcpy(cadastrado[j].endereco.estado , back[j].enderecoB.bestado);
                strcpy(cadastrado[j].endereco.cep , back[j].enderecoB.bcep);
